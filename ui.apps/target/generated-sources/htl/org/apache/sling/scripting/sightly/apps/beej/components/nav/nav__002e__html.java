...
public final class nav__002e__html extends RenderUnit {
...
_global_grouptemplate = renderContext.call("use", "group.html", obj());
    out.write("<nav class=\"beej-header__nav\" role=\"navigation\" itemscope itemtype=\"http://schema.org/SiteNavigationElement\"");
    {
        Object var_attrvalue0 = renderContext.getObjectModel().resolveProperty(_global_navigation, "accessibilityLabel");
        {
    ...
    out.write(">");
    {
        Object var_templatevar4 = renderContext.getObjectModel().resolveProperty(_global_grouptemplate, "group");
        {
            Object var_templateoptions5_field$_items = renderContext.getObjectModel().resolveProperty(_global_navigation, "items");
            {
                java.util.Map var_templateoptions5 = obj().with("items", var_templateoptions5_field$_items);
...
out.write("\n");
{
    Object var_templatevar6 = renderContext.getObjectModel().resolveProperty(_global_template, "placeholder");
    {
        ...
        {
            String var_templateoptions7_field$_classappend = "beej-header_nav";
            {
